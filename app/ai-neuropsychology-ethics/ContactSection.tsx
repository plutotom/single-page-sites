...
const CONTACTS = [
  { name: "KaLeigh Bungard, MS", email: "kaleigh.bungard@my.wheaton.edu" },
  { name: "Marin Frame, BA", email: "marin.frame@my.wheaton.edu" },
  { name: "Ashton Major, BA", email: "ashton.major@my.wheaton.edu" },
  { name: "Isaiah Proctor, BA", email: "isaiah.proctor@my.wheaton.edu" },
  { name: "William Struthers, PhD", email: "william.struthers@my.wheaton.edu" },
  { name: "Ben Pyykkonen, PhD", email: "ben.pyykkonen@my.wheaton.edu" },
] as const;
    ...
    <section className="mb-12" aria-label="Contact">
      ...
      <ul className="grid gap-3 sm:grid-cols-2" role="list">
        {CONTACTS.map(({ name, email }) => {
          const justCopied = Boolean(email) && copiedEmail === email;
          return (
            <li key={name}>
              <div
              ...
              >
                ...
                {email ? (
                  ...
                  <p className="text-sm text-(--gg-slate-muted)">
                    Email forthcoming
                  </p>
                )}
              </div>
